...
//Creating the Div tag inside the body
let div =document.createElement("div");
div.setAttribute("class", "container");

//Creating a div tag and appending it inside the div tag having container as class
let div2 = document.createElement("div");
div.append(div2);

//Heading inside the div2 tag
let heading = document.createElement("h1");
heading.setAttribute("id", "heading");
heading.innerHTML = "PAGINATION-VIEW";
div2.append(heading);
...
//Creation of paragraphs and appending inside the div tag
...
//Introducing button elements inside the newly created div tag and futher appending it to main divison tag
...
//storing the data from id's
let id = document.getElementById("id");
let name1 = document.getElementById("name");
let email = document.getElementById("email");
let currentItem=0;

//Initially when the page is loaded this will be the first item reflected
